...
{
	public Ecs.Game.Components.Core.RotationComponent Rotation { get { return (Ecs.Game.Components.Core.RotationComponent)GetComponent(GameComponentsLookup.Rotation); } }
	...
	public void AddRotation(UnityEngine.Quaternion newValue)
	{
		...
		var component = (Ecs.Game.Components.Core.RotationComponent)CreateComponent(index, typeof(Ecs.Game.Components.Core.RotationComponent));
	...
	public void CopyRotationTo(Ecs.Game.Components.Core.RotationComponent copyComponent)
	{
		var index = GameComponentsLookup.Rotation;
		var component = (Ecs.Game.Components.Core.RotationComponent)CreateComponent(index, typeof(Ecs.Game.Components.Core.RotationComponent));
		#if !ENTITAS_REDUX_NO_IMPL
