...
{
	public Ecs.Game.Components.Core.LocalPositionComponent LocalPosition { get { return (Ecs.Game.Components.Core.LocalPositionComponent)GetComponent(GameComponentsLookup.LocalPosition); } }
	...
	public void AddLocalPosition(UnityEngine.Vector3 newValue)
	{
		...
		var component = (Ecs.Game.Components.Core.LocalPositionComponent)CreateComponent(index, typeof(Ecs.Game.Components.Core.LocalPositionComponent));
	...
	public void CopyLocalPositionTo(Ecs.Game.Components.Core.LocalPositionComponent copyComponent)
	{
		var index = GameComponentsLookup.LocalPosition;
		var component = (Ecs.Game.Components.Core.LocalPositionComponent)CreateComponent(index, typeof(Ecs.Game.Components.Core.LocalPositionComponent));
		#if !ENTITAS_REDUX_NO_IMPL
