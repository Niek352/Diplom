...
{
	public Ecs.Game.Components.Core.PositionComponent Position { get { return (Ecs.Game.Components.Core.PositionComponent)GetComponent(GameComponentsLookup.Position); } }
	...
	public void AddPosition(UnityEngine.Vector3 newValue)
	{
		...
		var component = (Ecs.Game.Components.Core.PositionComponent)CreateComponent(index, typeof(Ecs.Game.Components.Core.PositionComponent));
	...
	public void CopyPositionTo(Ecs.Game.Components.Core.PositionComponent copyComponent)
	{
		var index = GameComponentsLookup.Position;
		var component = (Ecs.Game.Components.Core.PositionComponent)CreateComponent(index, typeof(Ecs.Game.Components.Core.PositionComponent));
		#if !ENTITAS_REDUX_NO_IMPL
